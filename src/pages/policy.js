  ...
  return (
    <>
      <header className={styles.header}>
        <Image src={bat} width={100} height={100} alt='Logo do batman'/>
      ...
      <main>
        <section className={styles.policy}>
              <div>
                  <p>
                      A sua privacidade é importante para nós. É política do site Virando Heroi respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <strong>Virando Heroi</strong>, e outros sites que possuímos e operamos.
                  </p>
                  <p>
                  ...
                  <p>
                      Fica, desde já, o titular de dados ciente que o conteúdo desta Política de Privacidade pode ser alterado a critério do site Virando Heroi, independente de aviso ou notificação.  Em caso de alteração, as modificações produzem todos os efeitos a partir do momento da disponibilização no site.
                  </p>
                  <p>
                      O site Virando Heroi não se responsabiliza caso você venha utilizar seus dados de forma incorreta ou inverídica, ficando excluído de qualquer responsabilidade neste sentido.
                  </p>
              </div>
              ...
              <div>
                  ...
                  <p>
                      O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o site Virando Heroi oferece e com caráter enunciativo, mas não limitativo:
                  </p>
                  <ol>
                      <li>
                      ...
                      <li>
                          Não causar danos aos sistemas físicos hardwares e lógicos softwares do site Virando Heroi, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados;
                      </li>
                      <li>
              ...
              <div>
                  ...
                  <p>
                      O site Virando Heroi empregará esforços para resguardar as informações e dados coletados do usuário pelo site. Todavia, considerando que não há meio de transmissão e retenção de dados eletrônicos plenamente eficaz e seguro, o site Virando Heroi não pode assegurar que terceiros não autorizados não logrem êxito no acesso indevido, eximindo-se de qualquer responsabilidade por danos e prejuízos decorrentes da conduta de terceiros, ataques externos ao site como: vírus, invasão ao banco de dados, vícios ou defeitos técnicos, assim como operacionais resultante da utilização do site e em razão de falhas de conexão.
                  </p>
              </div>
